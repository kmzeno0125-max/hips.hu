      ...
      <div className="mx-auto max-w-[720px] px-6 text-center">
        ...
        <Reveal direction="up" delay={0.3}>
          <a
            ...
            className="inline-flex items-center gap-3 font-body text-[15px] font-semibold bg-cyan text-navy px-8 py-[14px] rounded-[6px] shadow-[0_4px_16px_rgba(77,197,232,0.25)] hover:bg-cyan/80 transition-colors pointer-events-auto"
            aria-label="Jelentkezés ingyenes 15 perces konzultációra e-mailben"
          >
